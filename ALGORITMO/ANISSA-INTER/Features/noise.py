...
def statisticalValuesC(img):
    ...
    return [mediaCol, medianaCol,  maxCol, minCol, varianzaCol, kurtosisCol, skewnessCol, mediaRow, medianaRow, maxRow, minRow, varianzaRow, kurtosisRow, skewnessRow,ratio,totalMedia[0]]
